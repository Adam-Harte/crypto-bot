  ...
  if (heikinAshiResults.length > 52) {
    ...
    if (buySignal) {
      ...
      if (!inPosition) {
        ...
        try {
          fs.writeFileSync('C:/Users/adamh/Desktop/crypto-bot/logs/heikinAshi-ichimoku.txt', `buy at ${close}` + "\n", { flag: 'a+' });
        } catch (err) {
            console.error(err)
        }
    ...
    if (sellSignal) {
      ...
      if (inPosition) {
        ...
        try {
          fs.writeFileSync('C:/Users/adamh/Desktop/crypto-bot/logs/heikinAshi-ichimoku.txt', `sell at ${close}` + "\n", { flag: 'a+' });
        } catch (err) {
            console.error(err)
        }
        ...
        inPosition = false;
        try {
          fs.writeFileSync('C:/Users/adamh/Desktop/crypto-bot/logs/heikinAshi-ichimoku.txt', `profit at ${profit}` + "\n", { flag: 'a+' });
        } catch (err) {
            console.error(err)
        }
      }
